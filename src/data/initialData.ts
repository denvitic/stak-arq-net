...
export const initialAtelierInfo: AtelierInfo = {
  ...
  briefingNotificationEmail: 'geral@stakarquitectura.com',
  briefingSenderEmail: '',
...
export const initialPagesContent: SitePagesContent = {
  ...
  "secondaryButtonLabel": "Falar pelo WhatsApp"
    ...
    seo: {
      ...
      metaDescription: 'Gabinete de arquitectura de autor e design de ambientes de alto padrão em Luanda. Projectos residenciais de luxo, edifícios corporativos e fiscalização de obras.',
      metaKeywords: 'arquitectura luanda, arquitectos angola, design de interiores talatona, moradias luxo, atelier de arquitectura',
      canonicalUrl: 'https://stakarquitectura.com/',
      ogTitle: 'STAK Arquitectura & Design de Interiores | Luanda',
      ogDescription: 'Projectos residenciais e corporativos de excelência em Angola. Arquitectura de autor e soluções integradas de obra.',
      ogImage: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=85',
      ogUrl: 'https://stakarquitectura.com/',
      twitterTitle: 'STAK Arquitectura & Design de Interiores',
      twitterDescription: 'Gabinete de arquitectura de autor e design de ambientes de alto padrão em Luanda, Angola.',
      twitterImage: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=85',
      noIndex: false,
    },
  },
  atelier: {
  ...
  "secondaryButtonLabel": "Enviar Mensagem WhatsApp"
    ...
    seo: {
      ...
      metaDescription: 'Conheça o atelier STAK Arquitectura em Luanda. Rigor técnico, identidade bioclimática angolana e equipa multidisciplinar de arquitectos e engenheiros.',
      metaKeywords: 'atelier arquitectura luanda, arquitectos angola, história stak arquitectura, equipa arquitectura luanda',
      canonicalUrl: 'https://stakarquitectura.com/#sobre-nos',
      ogTitle: 'O Atelier & Filosofia | STAK Arquitectura',
      ogDescription: 'Arquitectura com alma e rigor tectónico em Luanda, Angola.',
      ogImage: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=1200&q=85',
      ogUrl: 'https://stakarquitectura.com/#sobre-nos',
      twitterTitle: 'O Atelier | STAK Arquitectura',
      twitterDescription: 'Filosofia arquitectónica e equipa de autores em Luanda, Angola.',
      twitterImage: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=1200&q=85',
      noIndex: false,
    },
  },
  projects: {
  ...
  "description": "A nossa equipa realiza a análise preliminar de ocupação, parâmetros urbanísticos do GPL e estudo volumétrico de rentabilidade."
    ...
    seo: {
      ...
      metaDescription: 'Explore o portfólio de residências unifamiliares, interiores corporativos e projectos comerciais desenvolvidos pela STAK Arquitectura em Angola.',
      metaKeywords: 'projectos arquitectura luanda, casas luxo angola, moradias talatona, portfólio arquitectura',
      canonicalUrl: 'https://stakarquitectura.com/#projectos',
      ogTitle: 'Portfólio de Projectos | STAK Arquitectura',
      ogDescription: 'Obras emblemáticas e projectos de autor em Luanda, Angola.',
      ogImage: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=85',
      ogUrl: 'https://stakarquitectura.com/#projectos',
      twitterTitle: 'Projectos | STAK Arquitectura',
      twitterDescription: 'Portfólio de arquitectura e interiores de luxo em Angola.',
      twitterImage: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=85',
      noIndex: false,
    },
  },
  ...
  "description": "Entre em contacto com a nossa equipa de coordenação para avaliarmos os requisitos do seu investimento."
    ...
    seo: {
      ...
      metaDescription: 'Projectos de arquitectura, licenciamento camarário, design de interiores, estudos bioclimáticos e fiscalização de obras em Angola.',
      metaKeywords: 'serviços arquitectura angola, licenciamento obras luanda, design interiores talatona, fiscalização obras',
      canonicalUrl: 'https://stakarquitectura.com/#servicos',
      ogTitle: 'Serviços Especializados | STAK Arquitectura',
      ogDescription: 'Soluções integradas de arquitectura, interiores e acompanhamento técnico de obras em Luanda.',
      ogImage: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1200&q=85',
      ogUrl: 'https://stakarquitectura.com/#servicos',
      twitterTitle: 'Serviços | STAK Arquitectura',
      twitterDescription: 'Especialidades arquitectónicas e fiscalização de obras em Luanda.',
      twitterImage: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1200&q=85',
      noIndex: false,
    },
  },
  articles: {
  ...
  "description": "Receba trimestralmente no seu e-mail análises arquitectónicas e novidades do atelier."
    ...
    seo: {
      ...
      metaDescription: 'Reflexões sobre arquitectura contemporânea tropical, sustentabilidade, materiais nobres e design de interiores em Luanda e no mundo.',
      metaKeywords: 'artigos arquitectura angola, tendências design interiores luanda, revista arquitectura',
      canonicalUrl: 'https://stakarquitectura.com/#artigos',
      ogTitle: 'STAK Journal | Arquitectura & Design',
      ogDescription: 'Ensaios, notícias e tendências do panorama arquitectónico angolano.',
      ogImage: 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=1200&q=85',
      ogUrl: 'https://stakarquitectura.com/#artigos',
      twitterTitle: 'Artigos & Publicações | STAK Arquitectura',
      twitterDescription: 'Publicações sobre arquitectura e urbanismo em Luanda.',
      twitterImage: 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=1200&q=85',
      noIndex: false,
    },
  },
  contacts: {
  ...
  "description": "Visite o nosso atelier na Av. 4 de Fevereiro ou agende uma reunião preliminar com a nossa equipa."
    ...
    seo: {
      ...
      metaDescription: 'Entre em contacto com o atelier STAK em Luanda. Solicite o seu estudo prévio, proposta técnica de arquitectura ou agende uma reunião presencial.',
      metaKeywords: 'contactos stak arquitectura, orçamento arquitectura luanda, briefing arquitectura angola, gabinete luanda',
      canonicalUrl: 'https://stakarquitectura.com/#contactos',
      ogTitle: 'Contacte a STAK Arquitectura | Luanda',
      ogDescription: 'Inicie o seu projecto de sonho connosco. Formulário de briefing e contactos directos.',
      ogImage: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=85',
      ogUrl: 'https://stakarquitectura.com/#contactos',
      twitterTitle: 'Contactos | STAK Arquitectura',
      twitterDescription: 'Agende uma reunião ou envie o seu briefing de arquitectura.',
      twitterImage: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=85',
      noIndex: false,
    },
  },
